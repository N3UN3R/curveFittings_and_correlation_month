...
def fitting_and_plotting(sorted_producer_numbers,sorted_price_means,producer_number, reached_price):
    ...
    print(producer_number.shape)
    print(reached_price.shape)
    print(sorted_producer_numbers.shape)
    ...
    #set title
    plt.title('Innere-Punkte-Methode: Producer-Haushalte und erreichter Strompreis')
