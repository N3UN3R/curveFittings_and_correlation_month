...
def get_producers_to_runtime(producer_number, runtime):
    """ function that transforms the lists from
        get_producers_and_price into a dictionary"""
...
def correlation_producers_runtime(sorted_producer_numbers,sorted_runtime_means,producer_number, runtime):
    ...
    plt.title('Innere-Punkte-Methode: Producer-Haushalte und Laufzeit')
    ...
    fig.savefig("producer_runtime_scalable.pdf")
    fig.savefig("producer_runtime_scalable.svg")
