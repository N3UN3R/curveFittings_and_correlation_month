...
def main():
    ...
    folder = 'Ergebnisse2020'

    path_to_results = os.path.abspath(os.path.join(os.getcwd(), folder))

    allFiles = os.listdir(path_to_results)

    filesToOpen = []
    for filename in allFiles:
        path_to_file = os.path.abspath(os.path.join(path_to_results, filename))
        filesToOpen.append(path_to_file)
    ...
    print("Einsparung in Euro")
    print(sum(month_saved)/100)

    print("Gehandelte Kilowattstunden")
